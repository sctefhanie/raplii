return function(Window, Tabs)
    ...
    local InfoSection = Tabs.Info:AddSection("Raplii Information", true)
...
If you have suggestions or found bugs, please report them to <font color="rgb(0,170,255)">Discord Raplii</font>!<br/>
<b>Use at your own risk!</b>
    ...
    InfoSection:AddParagraph({
        Title = "Raplii Discord",
        Content = "Official link discord Raplii!",
        Icon = "discord",
        ButtonText = "COPY LINK DISCORD",
        ButtonCallback = function()
            if setclipboard then
                setclipboard("https://discord.gg/hXpCC3fD")
        ...
        Callback = function(state)
            ...
            if queue_on_teleport then
                queue_on_teleport(state and [[
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/sctefhanie/raplii/refs/heads/main/m.lua"))()
                ]] or "")
            end
        end
    })
